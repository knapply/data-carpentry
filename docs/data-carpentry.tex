...
\usepackage[lmargin=0.375in, rmargin=0.375in, top=3cm, bottom=3cm]{geometry}
\usepackage{color}
\usepackage{fancyvrb}
\newcommand{\VerbBar}{|}
...
If your code doesn't form a complete \emph{expression}, then R will look for the rest of on the next line.
...
\texttt{1\ +} isn't a complete expression, so R will look for more on subsequent lines. You'll see something like the following:
